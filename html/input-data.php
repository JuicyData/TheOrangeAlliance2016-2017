	...
	<body>
		...
		<div class="content">
			...
			<h3>Validation Code <span class="glyphicon glyphicon-wrench"></span></h3>
				<input type="text" class="form-control" id="inputID" name="dataValidation">
			</div>
			</div>
			...
			Robot Parking</h3>
				...
				Robot Particles Scored in Center Vortex</h3>
					<div class="btn-group btn-group-justified" data-toggle="buttons">
						<div class="btn-group" role="group">
							<label class="btn btn-default redtext redbutton">
								<input type="radio" name="autoParticlesCenter" id="option1" autocomplete="off" value="0" required>0
							</label>
						</div>
						<div class="btn-group" role="group">
							<label class="btn btn-default redtext redbutton">
								<input type="radio" name="autoParticlesCenter" id="option1" autocomplete="off" value="1">1
							</label>
						</div>
						<div class="btn-group" role="group">
							<label class="btn btn-default redtext redbutton">
								<input type="radio" name="autoParticlesCenter" id="option1" autocomplete="off" value="2">2
							</label>
						</div>
						<div class="btn-group" role="group">
							<label class="btn btn-default redtext redbutton">
								<input type="radio" name="autoParticlesCenter" id="option1" autocomplete="off" value="3">3
							</label>
						</div>
					</div>
